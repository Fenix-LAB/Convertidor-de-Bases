...
// ConvertidorBases2.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CConvertidorBases2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CConvertidorBases2App

CConvertidorBases2App::CConvertidorBases2App()
{
...
// Único objeto CConvertidorBases2App

CConvertidorBases2App theApp;


// Inicialización de CConvertidorBases2App

BOOL CConvertidorBases2App::InitInstance()
{
